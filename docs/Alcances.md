...
- **Autenticación:** Registro, login con email/contraseña, autenticación OIDC/SSO mediante Keycloak (con federación de GitHub y Google) y recuperación de contraseña.
- **Gestión de usuarios y equipos:** Roles básicos (Owner, Developer, Reporter) para control de acceso a repositorios.
- **Repositorios Git:** Crear repositorios públicos y privados, subir/descargar archivos, navegación de estructura de carpetas, visualización de contenido, gestión de branches y fork de repositorios públicos, con microservicio Git hosteado y soporte básico solo por HTTPS (sin SSH).
